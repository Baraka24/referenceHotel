...
namespace Restau
{
    public partial class ProduitsUC : UserControl
    {
        ...
        private void FillcbxCodeCat()
        {
            ...
            conn.ConnectionString = "server=localhost;database=bar;uid=root;pwd=";
        ...
        private void notifierErreur()
        {
            ...
            {
                errorProvider1.SetError(txtQte, "Quantite invalide");
            }
            else
            {
            ...
            if (txtCodePro.Text == "")
            {
                errorProvider1.SetError(txtCodePro, "entrer le code Svp");
            }
            else
            {
            ...
            {
                errorProvider1.SetError(cbxCodeCat, "selectioner  le code Svp");
            }
            else
            {
